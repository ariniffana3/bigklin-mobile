...
const Print = props => {
  ...
  console.log(props.route.params.id, 'params');
  const getDataOrder = async () => {
    try {
      const result = await axios.get(`order/${props.route.params.id}`);
      ...
      <View>
        ...
        <View style={styles.btn}>
          <Button
            ...
            onPress={async () => {
              try {
                await BluetoothEscposPrinter.printPic(bigklin, {
                  width: 70,
                  left: 150,
                });
                ...
                await BluetoothEscposPrinter.printColumn(
                  ...
                  ['Jumlah Pakaian', data.jumlahPakaian],
                  {},
                );
                await BluetoothEscposPrinter.printColumn(
                  [16, 16],
                ...
                await BluetoothEscposPrinter.printColumn(
                  ...
                  ['Harga Total', `Rp. ${data.hargaTotal}`],
                  {},
                );
                await BluetoothEscposPrinter.printText('\r\n', {});
                await BluetoothEscposPrinter.printColumn(
